...
uses
  ...
  scControls, Vcl.StdCtrls, Vcl.ExtCtrls, cxCalendar;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        tb_RFQDetailUNIT.Value         := qry_RFQDetailUNIT.Value;
        tb_RFQDetailQTY.Value          := qry_RFQDetailQTY.Value;
        tb_RFQDetailCOST.Value         := qry_RFQDetailCOST.Value;
        tb_RFQDetailTOTAL.Value        := qry_RFQDetailTOTAL.Value;
        tb_RFQDetail.Post;
    ...
    begin
      ...
      upd_RFQ.Close;
      upd_RFQ.SQL[1] := 'SET SUMMARY  = '''+particulars+''',';
...
procedure Tf_RFQ.PrintExecute(Sender: TObject);
begin
  with dm_PM do
  begin
