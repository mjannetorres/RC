    ...
    begin
      ...
      begin
        ...
        begin
          ...
          brw_WorkLogs.ParamByName('DATE1').Value      := FormatDateTime('yyyy-mm-dd hh:nn', StartOfTheDay(qry_CashOutDetailPAYDATEFROM.Value));
          brw_WorkLogs.ParamByName('DATE2').Value      := FormatDateTime('yyyy-mm-dd hh:nn', EndOfTheDay(qry_CashOutDetailPAYDATETO.Value));
          brw_WorkLogs.Open();

         // ShowMessage(IntToStr(brw_WorkLogs.RecordCount));
