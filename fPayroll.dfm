object f_Payroll: Tf_Payroll
  ...
  object Panel3: TPanel
    ...
    object scGPGlyphButton1: TscGPGlyphButton
      ...
      GlyphOptions.Kind = scgpbgkSearch
  ...
  object s: TcxGrid
    ...
    object sDBTableView1: TcxGridDBTableView
      ...
      DataController.DataSource = ds_Payroll
      ...
      DataController.Summary.FooterSummaryItems = <
        ...
        item
          ...
          Column = sDBTableView1ALLOWANCES
        end
        item
          Format = '###,###,##0.00'
          Kind = skSum
          FieldName = 'BACKWAGE'
          Column = sDBTableView1BACKWAGE
        end
        item
          Format = '###,###,##0.00'
          Kind = skSum
          FieldName = 'BASICPAY'
          Column = sDBTableView1BASICPAY
        end
        item
          Format = '###,###,##0.00'
          Kind = skSum
          FieldName = 'LATE'
          Column = sDBTableView1LATE
        end
        item
          Format = '###,###,##0.00'
          Kind = skSum
          FieldName = 'NETPAY'
          Column = sDBTableView1NETPAY
        end
        item
          Format = '###,###,##0.00'
          Kind = skSum
          FieldName = 'OTHERS'
          Column = sDBTableView1OTHERS
        end
        item
          Format = '###,###,##0.00'
          Kind = skSum
          FieldName = 'PAGIBIG'
          Column = sDBTableView1PAGIBIG
        end
        item
          Format = '###,###,##0.00'
          Kind = skSum
          FieldName = 'PHIC'
          Column = sDBTableView1PHIC
        end
        item
          Format = '###,###,##0.00'
          Kind = skSum
          FieldName = 'SSS'
          Column = sDBTableView1SSS
        end
        item
          Format = '###,###,##0.00'
          Kind = skSum
          FieldName = 'ABSENCES'
          Column = sDBTableView1ABSENCES
        end
        item
          Format = '###,###,##0.00'
          Kind = skSum
          FieldName = 'CA'
          Column = sDBTableView1CA
        end>
      ...
      object sDBTableView1EMPCOUNT: TcxGridDBColumn
        Caption = '# OF EMP.'
        DataBinding.FieldName = 'EMPCOUNT'
        HeaderAlignmentHorz = taCenter
        Options.Editing = False
        Options.Filtering = False
        Options.Sorting = False
      ...
      object sDBTableView1BASICPAY: TcxGridDBColumn
        Caption = 'BASIC PAY'
      ...
      object sDBTableView1ALLOWANCES: TcxGridDBColumn
      ...
      object sDBTableView1BACKWAGE: TcxGridDBColumn
        Caption = 'BACK WAGE'
      ...
      object sDBTableView1LATE: TcxGridDBColumn
      ...
      object sDBTableView1ABSENCES: TcxGridDBColumn
      ...
      object sDBTableView1SSS: TcxGridDBColumn
      ...
      object sDBTableView1PAGIBIG: TcxGridDBColumn
      ...
      object sDBTableView1PHIC: TcxGridDBColumn
        Caption = 'PHILHEALTH'
      ...
      object sDBTableView1CA: TcxGridDBColumn
      ...
      object sDBTableView1OTHERS: TcxGridDBColumn
      ...
      object sDBTableView1NETPAY: TcxGridDBColumn
        Caption = 'NET PAY'
