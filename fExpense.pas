  ...
  begin
    ...
    begin
      ...
      begin
        ...
        del_ExpenseDetail.SQL[3] := 'CANCELLEDDATETIME = '''+FormatDateTime('yyyy-mm-dd hh:nn:ss', Now)+'''';
        del_ExpenseDetail.SQL[4] := 'WHERE HEADERID = '+qry_ExpenseID.AsString;
...
begin
  ...
  begin
    ...
    qry_ExpensePAYMENTMODE.Value  := 'CASH';
...
begin
  ...
  begin
    ...
    f_ExpenseTemp := Tf_ExpenseTemp.Create(Self);
    f_ExpenseTemp.PrintExecute(nil);
  end;
end;
...
procedure Tf_Expense.sDBTableView1CellClick(Sender: TcxCustomGridTableView;
  ...
  AShift: TShiftState; var AHandled: Boolean);
begin
  btnPrint.Visible  := dm_PM.brw_ExpensePOSTED.Value;
end;
