...
begin
  ...
  begin         //ExtractFilePath(Application.ExeName)+'imgs
    filename :=  dm_PM.map+'\logo\'+ dm_PM.qry_companyID.AsString+FormatDateTime('mmddyyyyhhnnss', Now)+ExtractFileExt(SavePictureDialog1.FileName);
