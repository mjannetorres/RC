object f_UsersTemp: Tf_UsersTemp
  Left = 0
  Top = 0
  ...
  object Panel2: TPanel
    ...
    object txt_lastname: TcxDBTextEdit
      ...
      DataBinding.DataSource = ds_Users
      ParentFont = False
    ...
    object chk_admin: TcxDBCheckBox
      Left = 276
      Top = 0
      Anchors = [akTop, akRight]
    ...
    object chk_reveal: TcxCheckBox
      ...
      TabOrder = 6
      Transparent = True
      OnClick = chk_revealClick
    end
  end
  object ds_Users: TDataSource
    DataSet = dm_PM.qry_Users
    Left = 40
    Top = 208
  end
end
