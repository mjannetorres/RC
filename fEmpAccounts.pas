...
type
  Tf_EmpAccounts = class(TForm)
    ...
    cxGrid1DBTableView1DATEFORWARDED: TcxGridDBColumn;
...
procedure Tf_EmpAccounts.date_1CloseUp(Sender: TObject);
begin
  LoadBalance;
end;

procedure Tf_EmpAccounts.date_2CloseUp(Sender: TObject);
begin
  LoadBalance;
end;
...
begin
  ...
  begin
    ...
    qry_EmpAccntsEMPID.Value               := brw_EmpRegID.Value;
    ...
    qry_EmpAccntsEFFECTIVITYDATE.Value     := IncDay(EndOfTheWeek(Now), -1);
