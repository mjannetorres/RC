object f_ExpenseTemp: Tf_ExpenseTemp
  Left = 0
  Top = 0
  ...
  object Panel3: TPanel
    ...
    object date_date: TcxDBDateEdit
      ...
      Top = 34
      Anchors = [akTop, akRight]
      DataBinding.DataField = 'EXPENSEDATE'
    ...
    object txt_Payee: TcxDBTextEdit
      Left = 71
      Top = 7
    ...
    object cxGridDBTableView1: TcxGridDBTableView
      ...
      DataController.Summary.FooterSummaryItems = <
        item
          ...
          Column = cxGridDBTableView1DESCRIPTION
        end
        item
          Format = '###,###,##0.00'
          Kind = skSum
      ...
      object cxGridDBTableView1DESCRIPTION: TcxGridDBColumn
        ...
        Properties.ListOptions.ShowHeader = False
        Properties.ListSource = ds_ExpType
      ...
      object cxGridDBTableView1AMOUNT: TcxGridDBColumn
        ...
        Properties.OnValidate = cxGridDBTableView1AMOUNTPropertiesValidate
        HeaderAlignmentHorz = taCenter
        Options.Filtering = False
        Options.Sorting = False
        Width = 81
  ...
  object ds_details: TDataSource
    DataSet = dm_PM.tb_ExpenseDetail
    Left = 264
    Top = 192
  end
