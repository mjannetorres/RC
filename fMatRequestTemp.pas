...
uses
  ...
  cxLabel, cxDBLabel, cxGroupBox, cxRadioGroup, Vcl.Menus, cxImageComboBox;
...
begin
  ...
  else if dm_PM.tb_InvReqDetailOLDQTY.Value < DisplayValue  then
  begin
    DisplayValue := 0;
...
begin
  ...
  begin
    ...
    begin
      ...
      brw_PMHeader.ParamByName('ROLEID').Value  := mat_roleid;
      brw_PMHeader.Open();
    end;
  end;
end;
