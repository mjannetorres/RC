object f_MatRequest: Tf_MatRequest
  Left = 0
  Top = 0
    ...
    object cxGrid1DBTableView1: TcxGridDBTableView
      ...
      DataController.Summary.FooterSummaryItems = <
        ...
        item
          ...
          Kind = skSum
          FieldName = 'TOTALCOST'
          Column = cxGrid1DBTableView1TOTALCOST
        end>
      ...
      object cxGrid1DBTableView1TOTALCOST: TcxGridDBColumn
        Caption = 'TOTAL COST'
      ...
      object cxGrid1DBTableView1REQDATETIME: TcxGridDBColumn
        Caption = 'REQ. DATE'
        DataBinding.FieldName = 'REQDATETIME'
        HeaderAlignmentHorz = taCenter
        Options.Editing = False
        Options.Filtering = False
        Options.Sorting = False
      ...
      object cxGrid1DBTableView1POSTEDDATETIME: TcxGridDBColumn
        Caption = 'POSTED DATE'
      ...
      object cxGrid1DBTableView1PAID: TcxGridDBColumn
        DataBinding.FieldName = 'REIMBURSED'
        HeaderAlignmentHorz = taCenter
        Options.Editing = False
        Options.Filtering = False
        Options.Sorting = False
