...
begin
  ...
  btnSave.Enabled := (txt_amnt.Style.BorderColor <> clRed) and (txt_received.Style.BorderColor <> clRed) and (txt_remarks.Style.BorderColor <> clRed);
end;

procedure Tf_CashIn.txt_amntExit(Sender: TObject);
begin
  manageui;
end;
